<template>
  <div class='flex'>
    <div v-for='position in count'>
      <svg
        @click='() => handleInput(position)'
        tabindex='0'
        class='cursor-pointer outline-none focus:border-amber-600 star mr-2'
        xmlns='http://www.w3.org/2000/svg'
        width='24'
        height='24'
        :class="{ 'fill-amber-300': (rating || 0) >= position, 'fill-gray-300': (rating || 0) < position }"
        viewBox='0 0 24 24'>
        <path
